...
has an interest in the activities of the Hacklab (as described in clause
\ref{clause:Purposes}) carried out in the east of Scotland.
 \footnote{GDE: totally not sure what
...
\clause{Upon ceasing to be a members, all keys, access tokens and
