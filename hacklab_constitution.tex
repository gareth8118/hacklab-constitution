...
[insert membership qualifications]\footnote{GDE: totally not sure what
  ...
  full discussion in the OSCR Charity Test document}.}
   \footnote{Jane: If we would add the home location of the member, we would need to collect and update this data. This adds a layer of privacy issues and administration work. I argue that we should not add any home location information of the members to the membership qualifications.}
