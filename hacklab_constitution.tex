...
[insert membership qualifications]\footnote{GDE: totally not sure what
  ...
  full discussion in the OSCR Charity Test document}.}
   \footnote{Jane: If we would add the home location of the member, we would need to collect and update this data. This adds a layer of privacy issues and administration work. Adding location information as a membership qualification into the constitution has a high "price tag"" and should be considered very carefully.}
...
\clause{\label{clause:disqualified}A person will not be eligible for
